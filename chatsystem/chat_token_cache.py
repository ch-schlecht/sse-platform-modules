...
def get_token_cache():
    ...
    """
    global the_chat_token_cache
    if the_chat_token_cache is None:
        the_chat_token_cache = Chatsystem_Token_Cache()
    return the_chat_token_cache


class Chatsystem_Token_Cache:
    """
    ...
    def insert(self, token, username, email, id):
        ...
        print("inserted into Chat cache: ")
        print(cache_obj)
    ...
    def _update_ttl(self, token):
        ...
        if token in self._data:
            ...
            print("updated Chat token ttl to: ")
            print(self._data[token])
